...
if train:
	...
	dA.fine_tune(train_nonoise, iterations=5000, regularisation=0.0, sparsity=0.0, beta=0., corruption=corruption, cost_fct=cost_fct)#regularisation=0.000, sparsity=0.05, beta=3.)
